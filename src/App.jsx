...
import HolidayScheduleClassic from "./pages/HolidayScheduleClassic";
      ...
      <Routes>
        ...
        <Route element={<RequireAuth />}>
          <Route element={<Layout />}>
            ...
            <Route path="/holiday/schedule" element={<HolidaySchedulePage />} />
            <Route path="holiday/form" element={<HolidayScheduleForm />} />

            <Route path="/holiday/schedule/classic/:date" element={<HolidayScheduleClassic />} />
